...
int main() {
    ...
    // Simula o tempo passando para garantir que o jogador não esteja piscando
    float deltaTime = 0.1f; // 100ms por frame
    for (int i = 0; i < 10; ++i) { // Simula 1 segundo
    ...
    std::cout << "Funcionalidade de tomar dano testada com sucesso." << std::endl;
